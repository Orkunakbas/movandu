...
export default function Component() {
  ...
  return (
    <footer className="flex w-full flex-col p-5">
    <div className="max-w-full px-0 pb-8 pt-16 sm:pt-24 lg:px-0 lg:pt-32">
      <div className="xl:grid xl:grid-cols-3 xl:gap-8">
        <div className="space-y-8 md:pr-8">
          <div className="flex items-center justify-start">
            <span className="text-medium font-medium">Movandu</span>
          </div>
